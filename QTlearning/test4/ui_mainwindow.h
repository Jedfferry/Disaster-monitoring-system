...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        opt1->setFont(font);
        opt1->setFocusPolicy(Qt::StrongFocus);
        ...
        opt2->setFont(font);
        opt2->setFocusPolicy(Qt::StrongFocus);
        ...
        lcdNumber->setStyleSheet(QStringLiteral("border-image: url(:/button.JPG);"));
        ...
        date_label->setCursor(QCursor(Qt::ForbiddenCursor));
        date_label->setFocusPolicy(Qt::StrongFocus);
        time_label = new QLabel(centralWidget);
        time_label->setObjectName(QStringLiteral("time_label"));
        time_label->setGeometry(QRect(30, 210, 161, 31));
        ...
        pushButton_2->setGeometry(QRect(260, 220, 75, 23));
        ...
        QWidget::setTabOrder(opt1, date_label);
        QWidget::setTabOrder(date_label, start);
        QWidget::setTabOrder(start, value);
        QWidget::setTabOrder(value, opt2);
        QWidget::setTabOrder(opt2, pushButton);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        pushButton_2->setText(QApplication::translate("MainWindow", "jump", 0));
    } // retranslateUi
