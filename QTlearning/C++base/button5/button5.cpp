...
public:
    Button(int X,int Y,int Width,int Height,unsigned long Color,const char *Pic_name,void (*Func)(void));
    ~Button();
...
Button :: Button(int X,int Y,int Width,int Height,unsigned long Color,const char *Pic_name,void (*Func)(void))
{
    cout<< " Button()" <<endl;
...
{
    Button button1(300,200,100,80,1111,"btn1.bmp",call_back1);
    Button button2(300,300,100,80,1111,"btn2.bmp",call_back2);
    Button button3(300,400,100,80,1111,"btn3.bmp",call_back3);
