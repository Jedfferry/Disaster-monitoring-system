...
int  button(int index,int x,int y,int width,int height,unsigned long color,char *pic_file,void (*func)(void *arg))
{
    struct Btn_attr Attr={index,0,x,y,width,height,color,pic_file,func}; 
...
int main(int argc,char *argv[])
{
    ...
    button(1,300,100,100,80,-1,"btn1.bmp",btn1_func);
	button(2,300,200,100,80,-1,"btn2.bmp",btn2_func);
	button(3,300,300,100,80,-1,"btn3.bmp",btn3_func);
